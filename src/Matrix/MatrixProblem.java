...
public class MatrixProblem {
	...
	public static boolean quadpart(int mat[][], int rowLength, int colLength, int target, int l, int u, int r, int d, int targetRow, int targetCol) {
		...
		if (target < mat[l][u] || target > mat[r][d])
			return false;
		...
		if (mat[row][col] > target) {
			return quadpart(mat, rowLength, colLength, target, col + 1, u, r, row, targetRow, targetCol) || quadpart(mat, rowLength, colLength, target, l,
					row + 1, col, d, targetRow, targetCol) || quadpart(mat, rowLength, colLength, target, l, u, col, row, targetRow, targetCol);
		} else {
			return quadpart(mat, rowLength, colLength, target, col + 1, u, r, row, targetRow, targetCol) || quadpart(mat, rowLength, colLength, target, l,
					row + 1, col, d, targetRow, targetCol) || quadpart(mat, rowLength, colLength, target, col + 1, row + 1, r, d, targetRow, targetCol);
		}
		// returning the cases for quad Partition
	}

	public static void main(String[] args) {
		int a[][] = {{1, 4, 7, 11}, {2, 5, 8, 12}, {3, 6, 9, 16}, {10, 13, 14, 17}, {18, 21, 23, 26},};
